...
api_key = '3154679534'
api_secret = '9a58cd921aea6db01ca37d4329ed92db'
callback_url = 'http://jas0n.me'
userid = 'jasondyq@foxmail.com'
password = 'dyq101829'
...
def check_user(userid):
  ...
  r = client.users.show.get(uid=userid)
  her_screen_name = r['screen_name']
...
def checkweather(num):
	site = ("http://weather.51wnl.com/weatherinfo/GetMoreWeather?cityCode=%s&weatherType=0") % num
	#print site
...
if __name__ == '__main__':
  ...
  # weibo_text("test")
  # weibo_pic('测试发布图片微博', '/home/jasondyq/test/test.png')
checkweather(city_num["chengdu"])
